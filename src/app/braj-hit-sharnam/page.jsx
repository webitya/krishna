    ...
    return (
        <div className="min-h-screen bg-[#fffcf5]">
            ...
            <section className="relative pt-24 pb-12 md:pt-32 md:pb-16 overflow-hidden">
                <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#FF9933]/5 rounded-full blur-[100px] -mr-64 -mt-64 opacity-60" />
                <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-[#FF9933]/5 rounded-full blur-[100px] -ml-64 -mb-64 opacity-60" />
                ...
                <div className="container mx-auto px-6 relative z-10 text-center">
                    ...
                    >
                        <h1 className="text-3xl md:text-5xl font-serif font-bold text-gray-900 mb-4 leading-tight">
                            श्री ब्रज हित <span className="text-[#FF9933]">शरणम् फाउंडेशन</span>
                        </h1>
                        ...
                        <div className="flex flex-wrap justify-center gap-3">
                            <button className="px-6 py-3 bg-[#FF9933] text-black font-bold rounded-xl hover:bg-black hover:text-white transition-all shadow-lg shadow-[#FF9933]/10 flex items-center gap-2 text-sm">
                    ...
                    >
                        {foundationServices.map((service, index) => (
                            <motion.div
                                ...
                                whileHover={{ y: -5 }}
                                className="bg-white p-6 rounded-[2rem] shadow-lg shadow-[#FF9933]/5 hover:shadow-xl transition-all duration-500 border border-transparent hover:border-[#FF9933]/10 group"
                            >
                                <div className={`${service.color} ${service.textColor} w-16 h-16 rounded-[1.2rem] flex items-center justify-center mb-4 transition-transform group-hover:scale-105 shadow-sm`}>
                                    {service.icon}
                                </div>
                                <h3 className="text-xl font-serif font-bold text-gray-900 mb-1">{service.title}</h3>
                                <p className="text-[#FF9933] text-[10px] font-bold tracking-widest uppercase mb-3 opacity-80 italic">{service.subtitle}</p>
                                <p className="text-gray-500 text-sm leading-relaxed mb-4">
                                    {service.description}
                                </p>
                                <div className="pt-3 border-t border-gray-50 flex items-center justify-between">
                                    <span className="text-gray-400 text-[10px] font-bold uppercase tracking-widest">Active Program</span>
                                    <Sparkles className="text-[#FF9933]/20" size={14} />
                                </div>
                            </motion.div>
                        ))}
                    </motion.div>
